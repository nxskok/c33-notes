...
outline_c33.md: outline_c33.Rmd 
	Rscript -e 'knitr::knit("outline_c33.Rmd")'
...
outline_c33.tex: outline_c33.md 
	/usr/lib/rstudio/bin/pandoc/pandoc +RTS -K512m -RTS outline_c33.md --to beamer --from markdown+autolink_bare_uris+ascii_identifiers+tex_math_single_backslash\
	       	--output outline_c33.tex --slide-level 2 --variable theme=AnnArbor --variable colortheme=dove --highlight-style tango\
	       	--pdf-engine xelatex --self-contained 
slides_c33.pdf: slides_c33.tex
	xelatex slides_c33.tex
outline_c33.pdf: outline_c33.tex
	xelatex outline_c33.tex
